...
bool Renderer::init(int width, int height, const std::string& shaderDir, int msaa,
    ...
    uGrassWalker_ = bgfx::createUniform("u_grassWalker", bgfx::UniformType::Vec4);
...
void Renderer::shutdown() {
    ...
    for (bgfx::UniformHandle* u :
         {&uSunDir_, &uSunColour_, &uSkyColour_, &uGroundColour_, &uDust_, &uCamPos_, &uParams_,
          &uMaterial_, &uTranslucency_, &uShadowMtx_, &uShadowParams_, &uShadowDebug_, &uShadowReach_, &uCamRay_, &uPrepassSize_, &uGroundRepeat_, &uGroundBlend_, &uGrassCard_, &uGrassWind_, &uGrassRoot_, &uGrassTip_, &uGrassVary_, &uGrassSheet_, &uGrassSize_, &uGrassReach_, &uGrassWalker_, &sAlbedo2_, &sNormal2_, &sOrm2_, &sAlbedo_,
